...
The Linux kernel is very picky about allowing access to Channel 13 for 802.11b - you'll likely need to patch your kernel to allow Channel 13, which the NDS seems to prefer sniffing on. Feel free to send an email to manassehpawlos@gmail.com if you're having trouble with that.
